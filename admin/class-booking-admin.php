...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    ...
    /**
        ...
        <div class="wrap booking-admin-page">
            ...
            <p><?php _e('Developed by: Firmansyah Pramudia Ariyanto', 'archeus-booking'); ?></p>
        </div>
        <?php
    }
    ...
    private function build_status_email_subject($booking, $subject_template, $status) {
        ...
        // Additional sanitization for email subject to prevent header injection
        $subject = str_replace(array("\r", "\n", "%0a", "%0d"), '', $subject);

        // Remove potential HTML/JS from subject
